...
namespace TournamentsXPanded.Patches.DefaultTournamentModelClass
{
    public class GetRenownReward : PatchBase<GetRenownReward>
    {
        ...
        private static readonly MethodInfo PatchMethodInfo = typeof(CreateTournament).GetMethod(nameof(Postfix), BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly);
