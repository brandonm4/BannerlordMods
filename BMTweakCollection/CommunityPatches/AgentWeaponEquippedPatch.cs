...
namespace CommunityPatch.Patches {
  ...
  public abstract class AgentWeaponEquippedPatch<TPatch> : PatchBase<TPatch> where TPatch : AgentWeaponEquippedPatch<TPatch> {
    ...
    public override void Apply(Game game) {
            BMTweakCollectionSubModule.Harmony.Patch(ItemMenuVmAddWeaponItemFlags, new HarmonyMethod(ItemMenuVmAddWeaponItemFlagsPrefix));
            BMTweakCollectionSubModule.Harmony.Patch(AgentWeaponEquipped, new HarmonyMethod(CallWeaponEquippedPrefix));
      Applied = true;
    }
