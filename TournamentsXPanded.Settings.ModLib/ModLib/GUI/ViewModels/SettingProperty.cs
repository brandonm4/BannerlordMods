using TXP.ModLib.Attributes;
using TXP.ModLib.GUI.GauntletUI;
...
namespace TXP.ModLib.GUI.ViewModels
{
    public class SettingProperty : ViewModel
    {
        ...
        public bool SatisfiesSearch
        {
            get
            {
                ...
                return Name.IndexOf(ScreenVM.SearchText, StringComparison.OrdinalIgnoreCase) >= 0;
            }
        }
