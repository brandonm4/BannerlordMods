using TournamentsXPanded.Settings.Debugging;
...
{
    public static class SettingsDatabaseTXP
    {
        ...
        /// <summary>
        /// Registers the settings class with the SettingsDatabaseTXP for use in the settings menu.
        /// </summary>
        /// <param name="settings">Intance of the settings object to be registered with the SettingsDatabaseTXP.</param>
        /// <returns>Returns true if successful. Returns false if the object's ID key is already present in the SettingsDatabaseTXP.</returns>
        ...
        /// <summary>
        /// Retrieves the Settings instance from the SettingsDatabaseTXP with the given ID.
        /// </summary>
